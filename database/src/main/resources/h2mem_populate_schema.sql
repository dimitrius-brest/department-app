insert into departments (name) values ('CEO-Mem');
insert into departments (name) values ('Economists-Mem');
insert into departments (name) values ('Programmers-Mem');
insert into departments (name) values ('Dummies-Mem');
